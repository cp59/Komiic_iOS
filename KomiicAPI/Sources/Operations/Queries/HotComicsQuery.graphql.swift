...
public class HotComicsQuery: GraphQLQuery {
  public static let operationName: String = "hotComics"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query hotComics($pagination: Pagination!) { hotComics(pagination: $pagination) { __typename ...ComicFrag } }"#,
  ...
  public struct Data: KomiicAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("hotComics", [HotComic?].self, arguments: ["pagination": .variable("pagination")]),
    ] }

    public var hotComics: [HotComic?] { __data["hotComics"] }

    /// HotComic
    ///
    /// Parent Type: `Comic`
    public struct HotComic: KomiicAPI.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
